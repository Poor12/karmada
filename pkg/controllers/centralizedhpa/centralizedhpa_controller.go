...
import (
	...
	"github.com/karmada-io/karmada/pkg/controllers/centralizedhpa/monitor"
...
// CentralizedHpa-controller is borrowed from the HPA controller of Kubernetes.
// The referenced code has been marked in the comment.

// ControllerName is the controller name that will be used when reporting events.
const ControllerName = "centralizedHpa-controller"
...
// CentralizedHorizontalPodAutoscalerController is to sync HorizontalPodAutoscaler.
type CentralizedHorizontalPodAutoscalerController struct {
	client.Client
...
func (c *CentralizedHorizontalPodAutoscalerController) SetupWithManager(mgr controllerruntime.Manager) error {
...
func (c *CentralizedHorizontalPodAutoscalerController) Reconcile(ctx context.Context, req controllerruntime.Request) (controllerruntime.Result, error) {
	...
	if err := c.Client.Get(ctx, req.NamespacedName, hpa); err != nil {
		if apierrors.IsNotFound(err) {
			klog.Infof("Horizontal Pod Autoscaler %s has been deleted in %s", req.Name, req.Namespace)
...
func (c *CentralizedHorizontalPodAutoscalerController) reconcileAutoscaler(ctx context.Context, hpa *autoscalingv2.HorizontalPodAutoscaler) (retErr error) {
	...
	if err != nil {
		...
		c.updateStatusIfNeeded(hpaStatusOriginal, hpa)
	...
	if placement == nil {
		// Never reach
		return fmt.Errorf("failed to get placement from binding")
	}
...
func (c *CentralizedHorizontalPodAutoscalerController) getBindingByLabel(resourceLabel map[string]string, resourceRef autoscalingv2.CrossVersionObjectReference) (*workv1alpha2.ResourceBinding, error) {
	...
	if resourceLabel[policyv1alpha1.PropagationPolicyNameLabel] != "" {
	...
	} else if resourceLabel[policyv1alpha1.ClusterPropagationPolicyLabel] != "" {
...
func (c *CentralizedHorizontalPodAutoscalerController) getTargetCluster(binding *workv1alpha2.ResourceBinding) ([]string, error) {
...
func (c *CentralizedHorizontalPodAutoscalerController) getResourceTemplateReplicas(targetResource *unstructured.Unstructured) (int32, error) {
	templateScaleObj := &unstructured.Unstructured{}
	err := c.Client.SubResource("scale").Get(context.TODO(), targetResource, templateScaleObj)
	if err != nil {
		return 0, fmt.Errorf("failed to get scale subresource for resource template: %v", err)
	}

	templateScale := &autoscalingv1.Scale{}
	err = helper.ConvertToTypedObject(templateScaleObj, templateScale)
	if err != nil {
		return 0, fmt.Errorf("failed to convert unstructured.Unstructured to scale: %v", err)
	}

	return templateScale.Spec.Replicas, nil
}

func (c *CentralizedHorizontalPodAutoscalerController) scaleForTargetCluster(clusters []string, hpa *autoscalingv2.HorizontalPodAutoscaler, mapping *meta.RESTMapping) (*autoscalingv1.Scale, []*corev1.Pod, error) {
	...
	for _, cluster := range clusters {
		...
		if !ok {
			return nil, nil, fmt.Errorf("failed to convert interface to PodLister")
		}
...
func (c *CentralizedHorizontalPodAutoscalerController) buildPodInformerForCluster(clusterScaleClient *util.ClusterScaleClient) (typedmanager.SingleClusterInformerManager, error) {
...
// L564-L1292 is partly lifted from https://github.com/kubernetes/kubernetes/blob/d8e9a7b33a25e97b0880558fc94318a5d2fb3664/pkg/controller/podautoscaler/horizontal.go.
...
func (c *CentralizedHorizontalPodAutoscalerController) computeReplicasForMetrics(ctx context.Context, hpa *autoscalingv2.HorizontalPodAutoscaler, scale *autoscalingv1.Scale,
	...
	calibration := scale.Spec.Replicas / specReplicas
	statusReplicas := scale.Status.Replicas / calibration
...
func (c *CentralizedHorizontalPodAutoscalerController) hpasControllingPodsUnderSelector(pods []*corev1.Pod) []selectors.Key {
	c.hpaSelectorsMux.Lock()
...
func (c *CentralizedHorizontalPodAutoscalerController) validateAndParseSelector(hpa *autoscalingv2.HorizontalPodAutoscaler, selector string, podList []*corev1.Pod) (labels.Selector, error) {
...
func (c *CentralizedHorizontalPodAutoscalerController) computeReplicasForMetric(ctx context.Context, hpa *autoscalingv2.HorizontalPodAutoscaler, spec autoscalingv2.MetricSpec,
	specReplicas, statusReplicas int32, selector labels.Selector, status *autoscalingv2.MetricStatus, podList []*corev1.Pod, calibration int32) (replicaCountProposal int32, metricNameProposal string,
...
func (c *CentralizedHorizontalPodAutoscalerController) computeStatusForResourceMetricGeneric(ctx context.Context, currentReplicas int32, target autoscalingv2.MetricTarget,
	resourceName corev1.ResourceName, namespace string, container string, selector labels.Selector, sourceType autoscalingv2.MetricSourceType, podList []*corev1.Pod, calibration int32) (replicaCountProposal int32,
...
func (c *CentralizedHorizontalPodAutoscalerController) computeStatusForResourceMetric(ctx context.Context, currentReplicas int32, metricSpec autoscalingv2.MetricSpec, hpa *autoscalingv2.HorizontalPodAutoscaler,
	selector labels.Selector, status *autoscalingv2.MetricStatus, podList []*corev1.Pod, calibration int32) (replicaCountProposal int32, timestampProposal time.Time,
...
func (c *CentralizedHorizontalPodAutoscalerController) recordInitialRecommendation(currentReplicas int32, key string) {
	c.recommendationsLock.Lock()
...
func (c *CentralizedHorizontalPodAutoscalerController) stabilizeRecommendation(key string, prenormalizedDesiredReplicas int32) int32 {
...
// minReplicas, etc...)
func (c *CentralizedHorizontalPodAutoscalerController) normalizeDesiredReplicas(hpa *autoscalingv2.HorizontalPodAutoscaler, key string, currentReplicas int32, prenormalizedDesiredReplicas int32, minReplicas int32) int32 {
...
func (c *CentralizedHorizontalPodAutoscalerController) normalizeDesiredReplicasWithBehaviors(hpa *autoscalingv2.HorizontalPodAutoscaler, key string, currentReplicas, prenormalizedDesiredReplicas, minReplicas int32) int32 {
...
func (c *CentralizedHorizontalPodAutoscalerController) maybeInitScaleDownStabilizationWindow(hpa *autoscalingv2.HorizontalPodAutoscaler) {
...
func (c *CentralizedHorizontalPodAutoscalerController) getUnableComputeReplicaCountCondition(hpa runtime.Object, reason string, err error) (condition autoscalingv2.HorizontalPodAutoscalerCondition) {
...
func (c *CentralizedHorizontalPodAutoscalerController) storeScaleEvent(behavior *autoscalingv2.HorizontalPodAutoscalerBehavior, key string, prevReplicas, newReplicas int32) {
	if behavior == nil {
...
func (c *CentralizedHorizontalPodAutoscalerController) stabilizeRecommendationWithBehaviors(args NormalizationArg) (int32, string, string) {
	now := time.Now()
...
func (c *CentralizedHorizontalPodAutoscalerController) convertDesiredReplicasWithBehaviorRate(args NormalizationArg) (int32, string, string) {
	...
	if args.DesiredReplicas > args.CurrentReplicas {
		...
		c.scaleDownEventsLock.RLock()
		defer c.scaleDownEventsLock.RUnlock()
		scaleDownLimit := calculateScaleDownLimitWithBehaviors(args.CurrentReplicas, c.scaleDownEvents[args.Key], c.scaleDownEvents[args.Key], args.ScaleDownBehavior)
...
func (c *CentralizedHorizontalPodAutoscalerController) setCurrentReplicasInStatus(hpa *autoscalingv2.HorizontalPodAutoscaler, currentReplicas int32) {
	c.setStatus(hpa, currentReplicas, hpa.Status.DesiredReplicas, hpa.Status.CurrentMetrics, false)
}

// setStatus recreates the status of the given HPA, updating the current and
// desired replicas, as well as the metric statuses
func (c *CentralizedHorizontalPodAutoscalerController) setStatus(hpa *autoscalingv2.HorizontalPodAutoscaler, currentReplicas, desiredReplicas int32, metricStatuses []autoscalingv2.MetricStatus, rescale bool) {
...
func (c *CentralizedHorizontalPodAutoscalerController) updateStatusIfNeeded(oldStatus *autoscalingv2.HorizontalPodAutoscalerStatus, newHPA *autoscalingv2.HorizontalPodAutoscaler) error {
...
func (c *CentralizedHorizontalPodAutoscalerController) updateStatus(hpa *autoscalingv2.HorizontalPodAutoscaler) error {
...
// not present.
func setCondition(hpa *autoscalingv2.HorizontalPodAutoscaler, conditionType autoscalingv2.HorizontalPodAutoscalerConditionType, status corev1.ConditionStatus, reason, message string, args ...interface{}) {
